---
title: 'How it works'
description: 'Deep dive: How Helium works'
icon: 'lightbulb'
---
...
-   Use our visual editor to create any paywall. You can add components from the layout tab, or drag right from the blocks tab onto the editor.
