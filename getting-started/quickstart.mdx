...
Let's start by importing products from the app store. 
...
with your Apple ID and selecting your app, selecting 
...
Let's start with a simple workflow and trigger. Go to the **Workflows** tab in the lefthand sidebar, and click **New Workflow**. Select the
...
You now have a workflow + trigger registered with Helium! Let's set up the SDK and go live with your new paywall.
...
- [ ] [Tested localized price display + in app purchases](/guides/storekit-testing)
