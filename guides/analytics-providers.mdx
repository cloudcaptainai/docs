...
That's it! Paywall events (see [Helium Events](/guides/helium-events)) will now come into Amplitude, prefixed with `helium_`
...
See [complete field reference](/guides/helium-events#experimentinfo-structure) for details.
...
For Mixpanel, PostHog, Statsig, and current Amplitude setup, see [Connect analytics and MMPs](/guides/analytics-forwarding).
