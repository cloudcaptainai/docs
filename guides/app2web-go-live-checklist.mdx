...
- [ ] Test the flow end to end with [Paywall Previews](/guides/paywall-previews) (triple tap). Start with a simulated purchase and confirm no transaction or entitlement is created; if the device is eligible, follow with a real purchase and confirm the entitlement is granted.
- [ ] Before launch, also open App2Web through a real trigger on a physical device. Previews bypass targeting and do not exercise paywall traits or your post-purchase handlers.
