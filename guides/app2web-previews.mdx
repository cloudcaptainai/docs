...
## Validating your analytics events
...
- A real purchase carries `helium_testing: true` on the checkout request and in the resulting Paddle subscription's `custom_data`, and any webhook the purchase drives carries the same marker — use it to find and clean up test subscriptions in your Paddle dashboard.
