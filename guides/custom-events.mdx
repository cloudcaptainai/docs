...
"Add a button that triggers an alert saying "Wait, there's more!" using custom actions"
...
<Tabs>
  <Tab title="iOS">
    ...
    - `params`: Dictionary of parameters from JavaScript
...
<Tip>
  Custom actions do not dismiss the paywall automatically. The paywall stays open unless you explicitly call `dismiss()` from JavaScript.
</Tip>
