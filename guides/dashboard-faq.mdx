  ...
  <Accordion title="How do I take a paywall live?">
    ...
    <Steps>
      <Step title="Publish it">
        In the paywall editor click **Publish Draft**, or **Save and Publish** if you have unsaved changes. If the warnings dialog appears, fix any errors. Warnings such as "No products detected" can be published past with **Publish Anyway**, but a paywall with no products cannot process purchases.
      </Step>
