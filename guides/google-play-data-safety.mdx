...
| Personal info | Name, Email address, Phone number, Address | 💡 Only if you put them into `HeliumUserTraits`, or if you use the optional payment-processing module. |
...
| Financial info | User payment info | 💡 Optional payment-processing module only. |
