...
<Tabs>
  <Tab title="iOS">
    ...
    // Payment processor for purchase events
    enum HeliumPaymentProcessor: String {
        case appStore
        case stripe
        case paddle
    }

    // How a restored entitlement was surfaced
    enum PurchaseRestoredOrigin: String {
        case restorePurchases       // User tapped Restore Purchases button
        case duringPurchase         // Purchase action resolved as restoration
        case detectedPostWebCheckout // Entitlement observed after web checkout
    }
  ...
  <Tab title="React Native">
    ...
    export type HeliumPaywallEvent = {
      ...
      paywallName?: string;
      productId?: string;
      paymentProcessor?: 'appStore' | 'stripe' | 'paddle';
      restoreOrigin?: 'restorePurchases' | 'duringPurchase' | 'detectedPostWebCheckout';
      buttonName?: string;
      configId?: string;
      numAttempts?: number;
...
| **productSelected**        | Fires when a user selects a product on the paywall                                                                      | `productId` (String) - Product identifier. Format varies by payment processor: StoreKit product ID for App Store, `prod_id:price_id` for Stripe, `pro_id:pri_id` for Paddle<br />`triggerName` (String) - Associated trigger<br />`paywallName` (String) - Paywall name<br />`isSecondTry` (Boolean) - True if paywall is "second try" flow<br />`timestamp` (Number) - When event occurred                                                                                                                                                                                                                                       |
| **purchasePressed**        | Fires when a purchase button is pressed in the paywall                                                                  | `productId` (String) - Product being purchased. Format varies by payment processor: StoreKit product ID for App Store, `prod_id:price_id` for Stripe, `pro_id:pri_id` for Paddle<br />`triggerName` (String) - Associated trigger<br />`paywallName` (String) - Paywall name<br />`isSecondTry` (Boolean) - True if paywall is "second try" flow<br />`timestamp` (Number) - When event occurred                                                                                                                                                                                                                                  |
| **purchaseSucceeded**      | Fires when a purchase is successfully completed.                                                                        | `productId` (String) - Product identifier. Format varies by payment processor: StoreKit product ID for App Store, `prod_id:price_id` for Stripe, `pro_id:pri_id` for Paddle<br />`triggerName` (String) - Associated trigger<br />`paywallName` (String) - Paywall name<br />`isSecondTry` (Boolean) - True if paywall is "second try" flow<br />`paymentProcessor` (String) - Which payment processor completed the purchase: `appStore`, `stripe`, or `paddle`<br />`storeKitTransactionId` (String, optional) - Transaction ID (App Store purchases only)<br />`storeKitOriginalTransactionId` (String, optional) - Original transaction ID (App Store purchases only)<br />`skPostPurchaseTxnTimeMS` (Number, optional) - Post-purchase transaction time<br />`timestamp` (Number) - When event occurred |
| **purchaseCancelled**      | Fires when the purchase process is cancelled by the user                                                                | `productId` (String) - Product that was cancelled. Format varies by payment processor: StoreKit product ID for App Store, `prod_id:price_id` for Stripe, `pro_id:pri_id` for Paddle<br />`triggerName` (String) - Associated trigger<br />`paywallName` (String) - Paywall name<br />`isSecondTry` (Boolean) - True if paywall is "second try" flow<br />`paymentProcessor` (String) - Which payment processor the cancelled purchase was attempted through: `appStore`, `stripe`, or `paddle`<br />`timestamp` (Number) - When event occurred                                                                                                                                                                                                                               |
| **purchaseFailed**         | Fires when the purchase fails for any reason                                                                            | `productId` (String) - Product that failed. Format varies by payment processor: StoreKit product ID for App Store, `prod_id:price_id` for Stripe, `pro_id:pri_id` for Paddle<br />`triggerName` (String) - Associated trigger<br />`paywallName` (String) - Paywall name<br />`isSecondTry` (Boolean) - True if paywall is "second try" flow<br />`paymentProcessor` (String) - Which payment processor the failed purchase was attempted through: `appStore`, `stripe`, or `paddle`<br />`error` (String, optional) - Error message<br />`timestamp` (Number) - When event occurred                                                                                                                                                                                      |
| **purchaseRestored**       | Fires when an existing entitlement is surfaced via restore or purchase flow                                             | `productId` (String) - Restored product ID (or `HELIUM_GENERIC_PRODUCT` when restoring all purchases)<br />`triggerName` (String) - Associated trigger<br />`paywallName` (String) - Paywall name<br />`isSecondTry` (Boolean) - True if paywall is "second try" flow<br />`restoreOrigin` (String) - How the restore was surfaced: `restorePurchases` (user tapped Restore Purchases button), `duringPurchase` (purchase action resolved as restoration), or `detectedPostWebCheckout` (entitlement observed after external web checkout)<br />`paymentProcessor` (String) - Which payment processor surfaced the restored entitlement: `appStore`, `stripe`, or `paddle`<br />`timestamp` (Number) - When event occurred                                                                                                                                                                                                                                      |
...
| **purchasePending**        | Fires when purchase is in a pending state (e.g. waiting for parental approval)                                          | `productId` (String) - Pending product<br />`triggerName` (String) - Associated trigger<br />`paywallName` (String) - Paywall name<br />`isSecondTry` (Boolean) - True if paywall is "second try" flow<br />`paymentProcessor` (String) - Which payment processor the pending purchase is going through: `appStore`, `stripe`, or `paddle`<br />`timestamp` (Number) - When event occurred                                                                                                                                                                                                                                          |
