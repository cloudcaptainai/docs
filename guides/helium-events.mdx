...
| **purchaseRestored**       | Fires when a previous purchase is successfully restored                                                                 | `productId` (String) - Restored product ID<br />`triggerName` (String) - Associated trigger<br />`paywallName` (String) - Paywall name<br />`isSecondTry` (Boolean) - True if paywall is "second try" flow<br />`paymentProcessor` (String, iOS only) - appStore, stripe, or paddle<br />`timestamp` (Number) - When event occurred                                                                                                                                                                                                                                      |
