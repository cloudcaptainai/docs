...
<Warning>
  On iOS, the on-device preview can't trigger a paywall's [second-try](/guides/makingpaywalls) flow — it shows a diagnostic titled "Second try flows can't be previewed" instead. To test a second-try flow, add the paywall to a workflow and trigger it there; real users who reach the paywall through a workflow still see it normally.
</Warning>
