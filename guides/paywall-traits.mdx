...
User traits can be used for targeting and can also be used as filters in your metrics. Rely on user traits as paywall traits if you need advanced metrics capabilities.
