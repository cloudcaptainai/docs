...
In your SDK integration, be sure to use one of the pre-built delegates (StoreKitDelegate/RevenueCatDelegate) or the `heliumPurchase` method in your custom delegate for proper tracking of purchases.
