...
Visit your [Stripe dashboard](https://dashboard.stripe.com/settings/payment_method_domains) and under **Payment method domains** and make sure you see **bundles.clickthrough.to** listed. If you do not, add it as a new domain.
