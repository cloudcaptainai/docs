...
- **Testing:** [App2Web previews and SDK requirements](/guides/paywall-previews#app2web-previews) cover real and simulated purchases on iOS across native, React Native, Expo, and Flutter SDKs. Also test through a real trigger to verify targeting and your post-purchase handlers.
