...
<Warning>
  In order to show paywalls with Stripe products, you are **required** to set a custom user ID. This ID will
  be used to grant Stripe entitlements across devices and re-installs.
</Warning>
