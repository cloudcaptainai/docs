...
<Tabs>
  ...
  <Tab title="Flutter">
    ...
    Open `ios/Runner.xcodeproj` in Xcode, click the **Signing & Capabilities** tab on the Runner target, and add the **Apple Pay** capability. Select the merchant ID you created in [Step 3](#3-get-an-apple-merchant-id) above.
