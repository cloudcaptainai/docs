...
<Card title="Download Full Event List" icon="download" href="/files/helium-events.csv">
  Download a CSV file containing all event names and descriptions
</Card>
...
| --- | --- |
| `paywall_open` | Paywall was opened and displayed to the user |
| `paywall_close` | Paywall was closed or dismissed |
| `paywall_response_load_start` | Started loading paywall configuration |
| `paywall_response_load_complete` | Finished loading paywall configuration |
| `paywall_response_load_fail` | Failed to load paywall configuration |
| `paywall_webview_load_start` | Started loading paywall webview |
| `paywall_webview_load_complete` | Finished loading paywall webview |
| `paywall_webview_load_fail` | Failed to load paywall webview |
| `transaction_start` | User initiated a purchase transaction |
| `transaction_fail` | Purchase transaction failed |
| `transaction_abandon` | User abandoned the purchase flow |
| `transaction_complete` | Purchase transaction completed successfully |
| `subscription_start` | New subscription started |
| `transaction_restore` | User restored previous purchases |
| `user_attributes` | User attributes were updated |
