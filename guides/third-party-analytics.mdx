...
<Tabs>
  <Tab title="Mixpanel">
    ...
    2. Give your integration a name. There's a few fields to enter due to what Mixpanel's API needs for event ingestion - we're always working on simplifying this integration, but the modal will indicate what's needed.
