...
<Tabs>
  <Tab title="Mixpanel">
    ...
    - If you're using an anonymous ID pre login, and want to override it to work _post_ login, you can use the `overrideUserId` method (available on all SDKs). View the relevant SDK quickstart for moe info!
