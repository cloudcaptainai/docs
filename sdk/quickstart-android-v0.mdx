---
title: "SDK Quickstart (Android) - v0"
description: "Integrate Helium into your Android app (v0 - deprecated)"
icon: "google-play"
---

<Warning>
  This guide is for **v0.x** of the Android SDK. For the latest version, see the [v4 quickstart](/sdk/quickstart-android).
</Warning>
