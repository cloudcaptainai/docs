...
- **Minimum Android SDK**: 24 or higher
...
<Tabs>
  <Tab title="Core (Android View System)">
    ...
    dependencies {
        ...
        implementation("com.tryhelium.paywall:core:0.0.5")
  ...
  <Tab title="Jetpack Compose UI">
    ...
    dependencies {
        // Choose one of the UI modules:
        implementation("com.tryhelium.paywall:compose-ui:0.0.5")
        // Other app dependencies
    }
    ```
  </Tab>
  <Tab title="RevenueCat">
    ...
    dependencies {
        ...
        implementation("com.tryhelium.paywall:revenue-cat:0.0.5")
        // Other app dependencies
    }
    ```
  </Tab>
