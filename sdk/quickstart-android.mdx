...
<Tabs>
  <Tab title="Core (Android View System)">
    ...
    dependencies {
        ...
        implementation("com.tryhelium.paywall:core:0.1.3")
  ...
  <Tab title="Jetpack Compose UI">
    ...
    dependencies {
        // Choose one of the UI modules:
        implementation("com.tryhelium.paywall:compose-ui:0.1.3")
        // Other app dependencies
    }
    ```
  </Tab>
  <Tab title="RevenueCat">
    ...
    dependencies {
        ...
        implementation("com.tryhelium.paywall:revenue-cat:0.1.3")
        // Other app dependencies
    }
    ```
  </Tab>
...
-   `fullscreen`: A `Boolean` to determine if the paywall should be displayed in fullscreen mode. This is optional and defaults to `false`.
