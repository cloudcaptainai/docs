...
<Tabs>
  <Tab title="Core (Android View System)">
    ...
    dependencies {
        ...
        implementation("com.tryhelium.paywall:core:0.1.1")
  ...
  <Tab title="Jetpack Compose UI">
    ...
    dependencies {
        // Choose one of the UI modules:
        implementation("com.tryhelium.paywall:compose-ui:0.1.1")
        // Other app dependencies
    }
    ```
  </Tab>
  <Tab title="RevenueCat">
    ...
    dependencies {
        ...
        implementation("com.tryhelium.paywall:revenue-cat:0.1.1")
        // Other app dependencies
    }
    ```
  </Tab>
