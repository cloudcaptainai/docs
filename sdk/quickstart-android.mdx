...
<Accordion title="In-App Paywall Links">
  By default, web links (`http`/`https`) opened via a paywall's navigate action open in-app in a Chrome Custom Tab over the paywall. To open them in the external browser instead:
