...
<Tabs>
  <Tab title="Core (Android View System)">
    ...
    dependencies {
        ...
        implementation("com.tryhelium.paywall:core:0.0.7")
  ...
  <Tab title="Jetpack Compose UI">
    ...
    dependencies {
        // Choose one of the UI modules:
        implementation("com.tryhelium.paywall:compose-ui:0.0.7")
        // Other app dependencies
    }
    ```
  </Tab>
  <Tab title="RevenueCat">
    ...
    dependencies {
        ...
        implementation("com.tryhelium.paywall:revenue-cat:0.0.7")
        // Other app dependencies
    }
    ```
  </Tab>
...
<Tabs>
  ...
  <Tab title="Android View System">
    ...
    Using the `HeliumPaywallActivity` requires you to create a subclass and implement the `HeliumNavigationDispatcher` interface.
...
You can also provide a custom `View` and fine-tune the loading behavior.
