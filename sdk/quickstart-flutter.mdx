...
Get set up with the Helium SDK for Flutter in 5 minutes. Reach out over your Helium slack channel, or email founders@tryhelium.com for any questions.
...
```
See [`https://www.revenuecat.com/docs/getting-started/configuring-sdk`](Google's guide on enabling SPM in Flutter) for more details.
