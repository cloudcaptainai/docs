...
void main() {
  ...
  heliumFlutter.initialize(
    ...
    // Defines a fallback paywall to show in case the user's device is not connected to the internet. This can be any Flutter view e.g. your existing one. It should be defined with subscription and post purchase navigation logic.
    fallbackPaywall: <your fallback paywall>
