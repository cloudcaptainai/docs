...
<Warning>
  The Helium Flutter SDK **currently supports iOS only. Android supported is expected mid- to late-November.**
</Warning>
...
You can use the `HeliumFlutter.getUpsellWidget` method to embed a paywall directly in your widget tree:
