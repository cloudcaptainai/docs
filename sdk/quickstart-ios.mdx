...
Helium checks entitlements directly through StoreKit and provides helper methods to make this easier. Consider using entitlements to gate premium features.
