...
<Accordion title="PaywallEventHandlers">
  Handle [Helium Events](/sdk/helium-events) directly with `presentUpsell`. You can chain a subset of handlers with builder syntax:
