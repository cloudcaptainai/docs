  ...
  <Expandable title="parameters">
    ...
    <ResponseField name="config" type="PaywallPresentationConfig?">
      ...
      struct PaywallPresentationConfig {
          ...
          // Custom traits to send to the paywall (see note below)
      ...
      <Note>
        User traits from `setUserTraits` and the trigger name are automatically included in `customPaywallTraits`. When keys overlap, explicitly provided `customPaywallTraits` values take precedence over user traits, and user traits take precedence over the trigger.
      </Note>
    </ResponseField>
