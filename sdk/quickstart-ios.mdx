  ...
  <Expandable title="parameters">
    ...
    <ResponseField name="config" type="PaywallPresentationConfig?">
      ...
      struct PaywallPresentationConfig {
          ...
          // How the paywall animates in via presentPaywall (.slideUp or .slideLeft).
          // Overrides the dashboard-configured style; nil uses the dashboard default.
          // Ignored by the embedded HeliumPaywall view and .heliumPaywall modifier.
          var presentationStyle: HeliumPresentationStyle? = nil
      }
      ```
    </ResponseField>
