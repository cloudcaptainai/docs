...
Only the `onOpen`, `onClose`, `onDismiss`, `onPurchaseSucceeded`, and `onCustomPaywallAction` events can be specified this way. For others, see the section on **HeliumPaywallDelegate**.
