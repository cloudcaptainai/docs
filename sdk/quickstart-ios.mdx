...
<CodeGroup>
  ...
  let hasPurchased = await Helium.shared.hasEntitlementForPaywall(trigger: heliumTrigger)
  if hasPurchased {
...
<Accordion title="Set a custom light mode/dark mode setting for paywalls">
