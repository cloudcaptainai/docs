...
<Accordion title="Reset Helium">
  ...
  Pass options to control what gets cleared:

  ```typescript
  await resetHelium({
    clearUserTraits: true,           // default: true
    clearExperimentAllocations: false // default: false
  });
  ```

  | Option | Default | Description |
  | ------ | ------- | ----------- |
  | `clearUserTraits` | `true` | Clear custom user traits |
  | `clearExperimentAllocations` | `false` | Clear experiment allocations |
</Accordion>
