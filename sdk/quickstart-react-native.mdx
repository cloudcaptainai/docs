...
Wrap a suitably root-y component with `HeliumProvider`. We recommend placing wrapping your navigation provider, but placing HeliumProvider UNDER your sentry error boundary, to make sure
errors get logged.
...
If you're using RevenueCat, you can wire up purchase configuration with `createRevenueCatPurchaseConfig`. If using custom logic, use `createCustomPurchaseConfig`.
...
- assigned on of your Offerings as "default"
