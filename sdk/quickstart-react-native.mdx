...
<Accordion title="Custom Purchase Config Example">
  <CodeGroup>
...
Listen for all [Helium Events](/guides/helium-events) by implementing `onHeliumPaywallEvent` and passing it to initialize:
...
By default, Helium will show this loading state as needed (a shimmer view for up to 7 seconds). You can configure or turn off this loading budget.
