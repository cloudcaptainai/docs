...
Install **@tryhelium/paywall-sdk** using your preferred package manager:

```bash
npm install @tryhelium/paywall-sdk
# or
yarn add @tryhelium/paywall-sdk
```
...
```tsx
import { HeliumProvider } from '@tryhelium/paywall-sdk';
...
```tsx
import { initializeHelium } from '@tryhelium/paywall-sdk';
