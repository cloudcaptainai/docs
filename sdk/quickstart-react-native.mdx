...
Install **@helium/react-native** using your preferred package manager:

```bash
npm install @helium/react-native
# or
yarn add @helium/react-native
```
...
```tsx
import { HeliumProvider } from '@helium/react-native';
...
```tsx
import { initializeHelium } from '@helium/react-native';
...
```typescript
import { useHeliumStatus } from '@helium/react-native';
...
```typescript
import { presentPaywall } from '@helium/react-native';
