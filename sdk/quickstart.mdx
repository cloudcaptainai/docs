...
await Helium.shared.initializeAndFetchVariants(
    ...
    // this view will be provided to you during setup! This view also defines the fallback paywall to show in case downloads fail.
...
```
Triggered when a subscription process fails for any reason.
